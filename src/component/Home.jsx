    ...
    return <div>
        ...
        <section class="about " id="about">
            ...
            <div class="about-content">
                ...
                <p className="aboutinfo">I am a software developer currently working at Aventisia, specializing in 
                    full-stack development. Previously, I worked with Elmech India Engineers, 
                    contributing to full-stack projects. I have experience in building impactful 
                    projects like Zobs, a job portal, and Foodiii, a cloud kitchen platform. My expertise lies 
                    in the MERN stack (MongoDB, Express.js, React.js, Node.js), and I am committed to delivering innovative
                     and efficient web solutions.
                     <br />

                    In addition to my professional experience, I actively engage in hackathons like HACKTOBERFEST and 
                    have a strong background in solving DSA problems on LeetCode. I am passionate about continuous learning and enhancing 
